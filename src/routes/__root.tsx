...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Tallaqee — A creative marketplace for artists with disabilities" },
      { name: "description", content: "Tallaqee empowers artists with disabilities to showcase, sell, and grow their work in an inclusive, accessible community." },
      { property: "og:title", content: "Tallaqee — A creative marketplace for artists with disabilities" },
      { property: "og:description", content: "Tallaqee empowers artists with disabilities to showcase, sell, and grow their work in an inclusive, accessible community." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Tallaqee — A creative marketplace for artists with disabilities" },
      { name: "twitter:description", content: "Tallaqee empowers artists with disabilities to showcase, sell, and grow their work in an inclusive, accessible community." },
